...
class DemoState3
: public sttcl::CompositeState<DemoState3,DemoStateMachine,IDemoState3,sttcl::CompositeStateHistoryType::Shallow>
{
public:
	typedef typename sttcl::CompositeState<DemoState3,DemoStateMachine,IDemoState3,sttcl::CompositeStateHistoryType::Shallow>::StateBaseClass InnerStateBaseClass;
	typedef sttcl::CompositeState<DemoState3,DemoStateMachine,IDemoState3,sttcl::CompositeStateHistoryType::Shallow> StateBaseClass;
