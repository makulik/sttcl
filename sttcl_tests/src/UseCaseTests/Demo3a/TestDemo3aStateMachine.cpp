...
#include "Demo3aActionDefinitions.h"

using ::testing::DoAll;
using ::testing::ByRef;

class TestDemo3aStateMachine: public ::testing::Test
{
public:

    typedef testing::NiceMock<Demo3a::Demo3aStateMachine> RootStateMachineType;

    TestDemo3aStateMachine()
    : demo3bStateMachine()
    ...
    virtual void SetUp()
    {
        ...
        ON_CALL(demoState3,handleEvent3(&demo3bStateMachine))
            .WillByDefault (
                DoAll
                ( Invoke(&demoState3, &Demo3a::DemoState3::propagateEvent3)
...
protected:
    ...
    typedef Demo3a::DemoState3::InnerStateBaseClass DemoState3InnerStateType;

    Demo3a::DemoState3::SimpleInnerStateType& demoState3a;
    Demo3a::DemoState3b& demoState3b;
    typedef Demo3a::DemoState3b::InnerStateBaseClass DemoState3bInnerStateType;
    Demo3a::DemoState3::SimpleInnerStateType& demoState3c;

    Demo3a::DemoState3b::SimpleInnerStateType& demoState3b_1;
    Demo3a::DemoState3b::SimpleInnerStateType& demoState3b_2;
    Demo3a::DemoState3b::SimpleInnerStateType& demoState3b_3;
...
TEST_F(TestDemo3aStateMachine,UseCaseScenario1)
{
...
TEST_F(TestDemo3aStateMachine,UseCaseScenario2)
{
