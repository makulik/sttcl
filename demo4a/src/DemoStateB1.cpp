...
void DemoStateB1::handleEvent1(IConcurrentStateMachine::Context* context,IConcurrentStateMachine::RegionContext* regionContext,sttcl::EventArgsPtr<EventArgsClass> eventArgs)
{
	cout << "DemoStateB1, handling event1, args data: '" << eventArgs->getData() << "' ..." << endl;
}
void DemoStateB1::handleEvent2(IConcurrentStateMachine::Context* context,IConcurrentStateMachine::RegionContext* regionContext,sttcl::EventArgsPtr<EventArgsClass> eventArgs)
{
	cout << "DemoStateB1, handling event2, args data: '" << eventArgs->getData() << "' ..." << endl;
}
void DemoStateB1::handleEvent3(IConcurrentStateMachine::Context* context,IConcurrentStateMachine::RegionContext* regionContext,sttcl::EventArgsPtr<EventArgsClass> eventArgs)
{
	cout << "DemoStateB1, handling event3, args data: '" << eventArgs->getData() << "' ..." << endl;
}
void DemoStateB1::handleEvent4(IConcurrentStateMachine::Context* context,IConcurrentStateMachine::RegionContext* regionContext,sttcl::EventArgsPtr<EventArgsClass> eventArgs)
{
